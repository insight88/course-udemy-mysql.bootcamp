-- * CHAR vs VARCHAR
-- ? CHAR(n) : 어떤 string input도 길이를 n으로 만든다
-- ? VARCHAR(n) : string 길이가 최대 n, 그보다 작을 때는 string input 길이 그대로
...
-- ? FLOAT : memory 4 Bytes, Precision 7 digits
-- ? DOUBLE : memory 8 Bytes, Precision 15 digits 
